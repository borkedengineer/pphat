...
| -------------- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| V<sub>LE</sub> | Velocity Landing Gear Extended | The highest speed an aircraft can safely fly with the landing gear extended                                           |
...
| V<sub>A</sub>  | Maneuvering Speed              | Maximum speed at which the aircraft is designed to maneuver; stall before structural damage (increase in load factor) |
| V<sub>S0</sub> | Stall Speed (Landing)          | Minimum flight speed in landing configuration                                                                         |
| V<sub>S1</sub> | Stall Speed (Flying)           | Minimum steady flight speed in a specific configuration                                                               |
